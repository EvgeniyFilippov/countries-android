...
//    override fun add(entity: RoomLanguageOfOneCountryDto) = db.getLanguageInfoDAO().add(entity)
...
//    override fun addAll(list: List<RoomLanguageOfOneCountryDto>) = db.getLanguageInfoDAO().addAll(list)
